...
4. Нажмите **Rent** и настройте пул:
   - **Pool Host**: `ВАШ_БЕЛЫЙ_IP` или `IP_VPS`
   - **Pool Port**: `3333`
   - **Username**: Ваш адрес TETSUO (например, `TApuot7dtebq7stqSrE3mo84ymKbgcC17s`)
   - **Password**: `x`
   - **Pool Type**: SHA256

### 8.3 Совместимость сложности

**КРИТИЧЕСКИ ВАЖНО: Проверьте перед арендой!**
